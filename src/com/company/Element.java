...
public class Element {
    ...
    public static Element getElementBySymbol(String inSymbol) {
        Element table[] = generateTable();
        for (int i = 1; i < 36; i++) {
            if (Objects.equals(table[i].getSymbol(), inSymbol)) {
    ...
    public static Element[] generateTable() {
        Element table[] = new Element[119];
        table[0] = new Element(0, new int[]{}, false, "Fail", "Invalid Input; try again");
        ...
        table[31] = new Element(31, new int[]{3}, true, "Ga", "Gallium");
        table[32] = new Element(32, new int[]{2, 4}, true, "Ge", "Germanium");
        table[33] = new Element(33, new int[]{3, 5, -3}, false, "As", "Arsenic");
        table[34] = new Element(34, new int[]{2, 4, 6, -2}, false, "Se", "Selenium");
        table[35] = new Element(35, new int[]{1, 5, -1}, false, "Br", "Bromine");
        table[36] = new Element(36, new int[]{0}, false, "Kr", "Krypton");
        return table;
    }
}
